...
// const express=require('express');
// const app = express();
//put in a route called calcquery takes in 2 parameters and a query for operations

    
    //console.log(request.params.numOne.numTwo, typeof request.params.numOne)// this was to test that we ahve
   //request.params.numOne,
   //request.params.numTwo,
    //`the object type of ${request.params.numOne} wgich is on the URL is ${typeof request.params.numOne}`,
    //app.get("/calcquery/:numOne/:numTwo", (request, response) => {
        // console.log(
        //     request.params.numOne, 
        //     request.params.numTwo, 
